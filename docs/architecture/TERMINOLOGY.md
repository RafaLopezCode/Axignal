...
| **XIGNAL** | An organization selected as a persistent focus of observation. "Xignal a company" = assign AXENT persistent observation budget. Technical shape: `ObservationSeed`. | A profile, a claim, ownership, or editing rights. |
